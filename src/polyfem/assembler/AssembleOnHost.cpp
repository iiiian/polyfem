...
namespace polyfem::assembler::detail
{
		...
		AssemblyCache &temp_cache)
	{
		...
		{
		case 1:
			compute_assembly_cache_single<1>(bases, geom_bases, element_id, is_mass, temp);
			break;
		case 2:
			compute_assembly_cache_single<2>(bases, geom_bases, element_id, is_mass, temp);
			break;
		case 3:
			compute_assembly_cache_single<3>(bases, geom_bases, element_id, is_mass, temp);
			break;
		default:
			assert(false);
		}
