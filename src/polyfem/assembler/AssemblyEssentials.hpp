...
namespace polyfem::assembler
{
	...
	public:
		AssemblyEssentialsView view() const;

		[[deprecated("Use AssemblyEssentials packed data directly")]]
		const std::vector<basis::ElementBases> &legacy_bases() const;
		...
		AssemblyValsCache legacy_assembly_vals_cache(
			...
			bool is_volume,
			bool is_mass = false) const;

		[[deprecated("Use AssemblyEssentials packed data directly")]]
		static AssemblyValsCache legacy_empty_assembly_vals_cache(bool is_mass = false);
