...
namespace polyfem
{
	namespace basis
	{
		...
		{
			return BarycentricBasis2d::build_bases(assembler_name, dim, mesh, n_bases, quadrature_order, mass_quadrature_order, meanvalue, meanvalue_derivative, bases, assembly, local_boundary, mapped_boundary);
		}
